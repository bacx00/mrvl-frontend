    ...
    <div className="max-w-6xl mx-auto space-y-4 text-sm scale-[0.8] origin-top-left transform w-[125%]">
      ...
      {match.broadcast && (
        <div className="card p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Watch</h3>
          <div className="flex space-x-4">
            {match.broadcast.stream && (
              <a 
                href={match.broadcast.stream} 
                target="_blank" 
            ...
            {!match.broadcast.stream && !match.broadcast.vod && (
              <div className="text-gray-600 dark:text-gray-400">
                Broadcast links will be available closer to match time
              </div>
            )}
          </div>
        </div>
      ...
      {/* PHASE 4: MATCH COMMENTS SECTION */}
      <div className="card p-6">
