...
const teamsData = [
  ...
  },
  {
    ...
    bannerImage: "/teams/100t-banner.jpg",
    country: "United States",
    region: "americas",
    city: "Los Angeles",
    founded: "2016-04-01",
    ...
    socials: {
      ...
      youtube: "https://youtube.com/100thieves",
    ...
    stats: {
      ...
      currentStreak: { type: "win", count: 6 },
      bestMap: "Asgard",
      worstMap: "Sanctum"
    },
    achievements: [
      { title: "Battle For Asgard 2025", placement: "1st", date: "2025-04-20", prize: 65000 },
      { title: "Championship Season 0 NA", placement: "1st", date: "2025-02-15", prize: 45000 },
      { title: "Rivals Fight Night #3", placement: "1st", date: "2025-03-10", prize: 25000 }
    ],
    sponsors: [
      { name: "Cash App", logo: "/sponsors/cashapp-logo.png", tier: "title" },
      { name: "Rocket Mortgage", logo: "/sponsors/rocketmortgage-logo.png", tier: "official" },
      { name: "JBL", logo: "/sponsors/jbl-logo.png", tier: "official" }
    ],
    fanStats: {
      followers: 2156789,
      engagement: 9.1,
    ...
    nextMatch: {
      ...
      event: "Marvel Rivals Ignite Americas Stage 1"
    }
  },
  {
    id: "5",
    ...
    bannerImage: "/teams/virtuspro-banner.jpg",
    country: "Russia",
    region: "emea",
    city: "Moscow",
    founded: "2003-11-01",
    ...
    socials: {
      ...
      youtube: "https://youtube.com/virtuspro",
      instagram: "https://instagram.com/virtuspro"
    },
    roster: [
      { 
        id: "501", 
    ...
    achievements: [
      { title: "Marvel Rivals Invitational EMEA", placement: "1st", date: "2025-04-25", prize: 85000 },
      { title: "Marvel Rivals Championship EMEA", placement: "1st", date: "2025-03-15", prize: 70000 },
      { title: "Rivals Fight Night EMEA #4", placement: "1st", date: "2025-04-05", prize: 30000 }
    ],
    sponsors: [
      { name: "G2A", logo: "/sponsors/g2a-logo.png", tier: "title" },
      { name: "HyperX", logo: "/sponsors/hyperx-logo.png", tier: "official" },
      { name: "MSI", logo: "/sponsors/msi-logo.png", tier: "official" }
    ],
    fanStats: {
      followers: 1445623,
      engagement: 8.7,
    ...
    nextMatch: {
      ...
      event: "Marvel Rivals Ignite EMEA Stage 1"
    }
  }
];
