                    ...
                    <div key={match.id} className="p-4 hover:bg-[#0f1923] transition-colors">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1 text-right pr-4">
                          <Link href={`/teams/${(match.team1 || '').toString().toLowerCase().replace(/\s+/g, '-')}`} className="hover:text-[#fa4454] font-medium">
                            {match.team1 || 'TBD'}
                          </Link>
                        </div>
                        ...
                        <div className="flex-1 pl-4">
                          <Link href={`/teams/${(match.team2 || '').toString().toLowerCase().replace(/\s+/g, '-')}`} className="hover:text-[#fa4454] font-medium">
                            {match.team2 || 'TBD'}
                          </Link>
                        </div>
                      </div>
                    ...
                    .map((team, index) => (
                      <div key={team.name} className={`flex items-center justify-between py-2 ${
                        ...
                        <div className="flex items-center">
                          ...
                          <Link href={`/teams/${(team.name || '').toString().toLowerCase().replace(/\s+/g, '-')}`} className="hover:text-[#fa4454] font-medium text-sm">
                            {team.name || 'TBD'}
                          </Link>
                        </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {event.teams
                          ...
                          .map(team => (
                            <Link 
                              key={team.name} 
                              href={`/teams/${(team.name || '').toString().toLowerCase().replace(/\s+/g, '-')}`}
                      ...
                      {event.teams
                        ...
                        .map((team) => (
                          <tr key={team.name} className="border-b border-[#2b3d4d] hover:bg-[#0f1923] transition-colors">
                            ...
                            <td className="p-3">
                              <Link href={`/teams/${(team.name || '').toString().toLowerCase().replace(/\s+/g, '-')}`} className="flex items-center hover:text-[#fa4454]">
                                <div className="w-8 h-8 bg-[#0f1923] rounded mr-3 flex items-center justify-center">
                                  <span className="text-xs font-bold">{(team.name || 'T').charAt(0)}</span>
                                </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center flex-grow mx-8">
                      <div className="flex-1 text-right">
                        <Link href={`/teams/${(match.team1 || '').toString().toLowerCase().replace(/\s+/g, '-')}`} className="font-medium hover:text-[#fa4454]">
                          {match.team1 || 'TBD'}
                        </Link>
                      </div>
                      ...
                      <div className="flex-1">
                        <Link href={`/teams/${(match.team2 || '').toString().toLowerCase().replace(/\s+/g, '-')}`} className="font-medium hover:text-[#fa4454]">
                          {match.team2 || 'TBD'}
                        </Link>
                      </div>
                    </div>
