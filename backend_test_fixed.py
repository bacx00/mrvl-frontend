...
class MarvelRivalsBackendTester:
    ...
    def test_match_detail_data(self, matches_data):
        ...
        elif isinstance(matches_data, dict) and 'data' in matches_data:
        ...
        for i, match in enumerate(matches[:3]):
            ...
            if match_success:
                ...
                match_data = match_detail
                if isinstance(match_detail, dict) and 'data' in match_detail:
                    match_data = match_detail['data']
                
                # Verify match detail structure
                required_fields = ['id', 'team1', 'team2', 'status']
                ...
                if missing_fields:
                    ...
                    for team_key in ['team1', 'team2']:
                        if team_key in match_data and isinstance(match_data[team_key], dict):
    ...
    def test_authentication_system(self):
        ...
        if login_success:
            ...
            elif isinstance(login_data, dict) and 'data' in login_data and 'token' in login_data['data']:
    ...
    def test_live_match_data(self):
        ...
        if 'maps' in match_data and isinstance(match_data['maps'], list):
            ...
            for i, map_data in enumerate(match_data['maps']):
                ...
                team1_score = map_data.get('team1Score', map_data.get('team1_score', '?'))
                team2_score = map_data.get('team2Score', map_data.get('team2_score', '?'))
                print(f"  Map {i+1}: {map_name}")
