...
const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <article className={`bg-[#1a2332] border border-[#2b3d4d] rounded-lg overflow-hidden ${className}`}>
      <div className="flex">
        
        {/* Author Sidebar */}
        <div className="w-48 bg-[#0f1419] border-r border-[#2b3d4d] flex-shrink-0">
          <div className="p-4">
